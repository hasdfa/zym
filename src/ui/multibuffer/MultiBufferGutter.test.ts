...
const seg = (sourceKey: string, startRow: number, endRow: number) =>
  ({ sourceKey, startRow, endRow, editable: false, kind: 'real' as const });

test('line-number gutter: source rows show sourceRow+1; block rows are blank', () => {
