; Vendored verbatim from zed-industries/zed: crates/grammars/src/tsx/highlights.scm
;   https://github.com/zed-industries/zed/blob/main/crates/grammars/src/tsx/highlights.scm
; Copyright Zed Industries; licensed GPL-3.0 (see /LICENSE). Compiles unmodified
; against tree-sitter-tsx (bundled by tree-sitter-wasms). The tsx grammar is a
; superset that also parses plain JS + JSX, so it backs .tsx/.jsx/.js/.mjs/.cjs
; (see grammar.ts). Only this header is local.
