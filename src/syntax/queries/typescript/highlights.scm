; Vendored verbatim from zed-industries/zed: crates/grammars/src/typescript/highlights.scm
;   https://github.com/zed-industries/zed/blob/main/crates/grammars/src/typescript/highlights.scm
; Copyright Zed Industries; licensed GPL-3.0 (see /LICENSE). Compiles unmodified
; against tree-sitter-typescript v0.20.5 (bundled by tree-sitter-wasms). Used for
; .ts/.mts/.cts. Only this header is local.
